...
\EPSsetup{
  ...
  titulo = {Sistema robótico inteligente para la patrulla y detección de incidencias en estancias cerradas},

  % Subtítulo (se muestra en portada B/N).
  % Retirado por indicación del tutor: el título principal es suficiente. La
  % plantilla no admite dejar la clave vacía (rompe la portada B/N), así que se
  % usa un marcador invisible para que no aparezca texto de subtítulo.
  subtitulo = {~},
  ...
  tutor = {Francisco A. Pujol López},
  tutor-genero = m,  % m = masculino, f = femenino, n = neutro
  tutor-departamento = {Tecnología Informática y Computación},
...
%% =============================================================================
%% CORRECCIÓN DE NOMBRES AUTOMÁTICOS EN ESPAÑOL
%% El español de polyglossia genera "Índice general" e "Índice de figuras" sin
%% espacio ("Índicegeneral"/"Índicedefiguras"). Los redefinimos con el espacio
%% correcto, igual que la plantilla ya hace con "Índice de tablas".
%% =============================================================================
