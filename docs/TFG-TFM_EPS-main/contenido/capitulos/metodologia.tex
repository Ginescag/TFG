...
Finalmente, todo el código se ha organizado como un \textbf{repositorio monolítico}, es decir,
...
espacio desconocido hasta completar el mapa. Una vez construido y guardado el mapa, los
arranques posteriores operan en modo de localización sobre él, con \gls{nav2} apoyándose
en AMCL en lugar de en \gls{slam}. Reutilizar estas soluciones, en lugar
...
\acrshort{cpu} del propio robot a una velocidad suficiente para la patrulla, sin
necesidad de una \acrshort{gpu} dedicada. La biblioteca aporta, además, modelos
